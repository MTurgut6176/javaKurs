...
public class WrapperClass01 {
    ...
    public static void main(String[] args) {
        ...
        //"primitive: nasil "wrapper"lara donusur (Autoboxing)
        float f1 = 13.99F;

        Float wrapperF1 = f1;

        //"wrapper"lar nasil "primitive cevrilir
        Character W1 = 's';

        char primitiveW1 = 'w';

        //Note: Autoboxing ve Unboxing Java tarafindan otomatik yapilir.kod yazmaya gerek yok
